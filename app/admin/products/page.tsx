      ...
      <section className="overflow-hidden bg-white shadow-sm">
        <div className="flex items-center justify-between border-b border-gray-200 px-5 py-4">
          ...
          <Link
            ...
            className="round bg-[#26c281] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#20a66e]"
          >
            Add Product
          </Link>
        </div>
            ...
            <tbody>
              {products.map((product) => (
                ...
                >
                  ...
                  <td className="px-5 py-4 text-gray-700">{product.name}</td>

                  <td className="px-5 py-4">${product.price.toFixed(2)}</td>

                  <td className="px-5 py-4">{product.offer}%</td>
